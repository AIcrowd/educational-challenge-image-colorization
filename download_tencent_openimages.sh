...
python2.7 ./download_urls_multithreading.py --url_list=train_urls_from_openimage.txt --im_list=train_im_from_openimage.txt --num_threads=5 --save_dir='./data/openimages-train'
echo "Done"
